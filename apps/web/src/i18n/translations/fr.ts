export const fr = {
  nav: {
    ...
    contact: "Contact",
    booking: "Rendez-vous",
    bookingLong: "Prendre rendez-vous",
    bookingShort: "RDV",
  ...
  hero: {
    ...
    slides: [
      ...
      },
      {
        ...
        title1: "Une défense",
        title2: "à la hauteur de vos enjeux.",
        subtitle:
          "Chaque dossier bénéficie d'une stratégie juridique sur mesure fondée sur l'excellence, la confidentialité et l'engagement.",
      },
    ],
  },
  home: {
    ...
    valuesSubtitle:
      "Les principes qui structurent chaque intervention du cabinet.",
    value1: "Confidentialité",
    value1Text:
      "Vos informations et échanges sont protégés par une éthique stricte et un secret professionnel absolu.",
    value2: "Neutralité",
    value2Text:
      "Nous analysons chaque dossier avec objectivité pour recommander la voie la plus pertinente.",
    value3: "Indépendance",
    value3Text:
      "Nos conseils sont libres de toute influence. Vos intérêts guident exclusivement nos décisions.",
    value4: "Rapidité",
    value4Text:
      "Urgences, délais procéduraux, opportunités : nous agissons avec réactivité et maîtrise du temps.",
    value5: "Expertise",
    value5Text:
      "Une compétence technique approfondie au service de stratégies juridiques efficaces et durables.",
    areasEyebrow: "Compétences",
    areasTitle: "Nos domaines d'intervention",
    areasSubtitle:
      "Un accompagnement spécialisé sur l'ensemble de vos enjeux juridiques.",
    areasCta: "Voir tous les domaines",
  ...
  contact: {
    seoTitle: "Contact",
    seoDesc:
      "Contactez RC Consulting — Bruxelles (Belgique) et Kinshasa (RDC).",
    heroTitle: "Contact",
    heroSubtitle:
    ...
    hours: "Horaires",
    hoursValue: "Lundi – Vendredi : 8h30 – 18h00",
    formEyebrow: "Message",
  ...
  expertise: {
    ...
    more: "En savoir plus →",
    back: "← Toutes les expertises",
    presentation: "Présentation",
    situations: "Situations concernées",
    situationsEyebrow: "Cas traités",
    accompaniment: "Notre accompagnement",
    accompanimentEyebrow: "Méthode",
  ...
  booking: {
    seoTitle: "Prendre rendez-vous",
    seoDesc: "Réservez une consultation au cabinet RC Consulting.",
    heroTitle: "Prendre rendez-vous",
    heroSubtitle: "Choisissez la durée, la date, puis un créneau disponible.",
    step1: "Durée",
    step2: "Date",
    step3: "Heure",
    ...
    confirmedSubtitle: "Votre rendez-vous est enregistré.",
    confirmedText:
      "Un email de confirmation vous a été envoyé avec un lien pour modifier ou annuler votre rendez-vous.",
    manage: "Gérer mon rendez-vous",
  },
  faqPage: {
    seoTitle: "FAQ",
    seoDesc:
      "Questions fréquentes sur le cabinet RC Consulting, les rendez-vous et les services.",
    heroTitle: "FAQ",
    heroSubtitle: "Retrouvez les réponses aux questions les plus fréquentes.",
    eyebrow: "Aide",
  ...
  legalPage: {
    ...
    seoDesc: "Mentions légales du site RC Consulting.",
    ...
    ipBody:
      "L'ensemble des contenus du site (textes, images, logos) est protégé. Toute reproduction non autorisée est interdite.",
  },
  privacyPage: {
    seoTitle: "Politique de confidentialité",
    seoDesc:
      "Politique de confidentialité et protection des données personnelles — RC Consulting.",
    ...
    dataBody:
      "Dans le cadre de ses relations commerciales avec ses clients, RC-Consulting collecte les données nécessaires à la prise de rendez-vous, au traitement de vos messages et à la gestion de votre dossier (identité, coordonnées, contenu des échanges).",
...
export type TranslationDict = DeepStringify<typeof fr>;
